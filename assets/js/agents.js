  ...
  function grantScoutSim(p) {
    if (p.includes("json")) {
      ...
      return JSON.stringify([
        { funder: "Michigan State Housing Development Authority (MSHDA)", funder_type: "government", focus_area: "Affordable housing & neighborhood revitalization (state)", fit_reason: "State housing dollars fund the home-rehab side of our model.", est_amount: "$50,000–$250,000 (verify)", deadline_note: "Annual NOFO / verify", url: "[michigan.gov/mshda — verify]", first_step: "Check current NOFOs; register as an applicant" },
        { funder: "City of Detroit — Housing & Revitalization Dept (CDBG)", funder_type: "government", focus_area: "Local housing rehab & workforce (city)", fit_reason: "City CDBG/ARPA funds neighborhood rehab and job training in Detroit.", est_amount: "$25,000–$150,000 (verify)", deadline_note: "City RFP cycle / verify", url: "[detroitmi.gov — verify]", first_step: "Watch the city's RFP portal; introduce the org to HRD" },
        { funder: "Detroit Land Bank Authority — rehab program / RFP", funder_type: "government", focus_area: "City project (contract / earned revenue)", fit_reason: "DLBA lists vacant-home rehab projects we can bid on — earned revenue, not a grant.", est_amount: "Per-project bid (verify)", deadline_note: "Rolling RFPs / verify", url: "[buildingdetroit.org — verify]", first_step: "Register as a contractor; watch project listings" },
        { funder: "Detroit-area community foundation (e.g., CFSEM / Kresge / Gilbert)", funder_type: "foundation", focus_area: "Workforce & neighborhood revitalization", fit_reason: "Regional funders back Detroit trades + housing work like ours.", est_amount: "$10,000–$100,000 (verify)", deadline_note: "Rolling / verify", url: "[funder website — verify]", first_step: "Submit a brief LOI or request a call" },
      ], null, 2);
    }
    return [
