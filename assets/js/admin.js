    ...
    view.innerHTML = `
      ...
      <div class="panel"><div class="panel-head"><h3>Database connection</h3><span class="env-badge ${DEMO ? "demo" : "live"}">${DEMO ? "Demo mode" : "Live · connected"}</span></div><div class="panel-body">
        <ol class="text-soft" style="line-height:1.9;padding-left:1.2rem">
          ...
          <li>Run, in order, <code>supabase/schema.sql</code>, <code>schema_hub_2026-09-03_1710.sql</code>, <code>schema_finance_2026-09-03_1740.sql</code>, <code>schema_finance_projects_2026-09-03_1755.sql</code>, <code>schema_zeffy_2026-09-05_1535.sql</code>, <code>schema_raffle_2026-09-08_2210.sql</code>, and <code>schema_updates_2026-09-09_0911.sql</code> in the SQL Editor.</li>
